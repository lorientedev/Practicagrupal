...
PROCEDURE Subtract ( var overflow: boolean; big_number_1: t_numbers; big_number_2: t_numbers; var result_total: t_numbers);  forward;
...
BEGIN
		...
		BEGIN
			result_total.ispositive:= FALSE;
			Subtract( overflow, big_number2, big_number1, result);
		END;
...
BEGIN
  ...
  IF ((big_number_1.ispositive) AND (big_number_2.ispositive) AND (NumberOFDigits(big_number_1) = NumberOFDigits(big_number_2))) THEN
    ...
    BEGIN
      ...
      IF (i> NumberOFDigits (big_number_1)) THEN
         Igual:= TRUE
...
PROCEDURE Subtract ( var overflow: boolean; big_number_1: t_numbers; big_number_2: t_numbers; var result_total: t_numbers);
